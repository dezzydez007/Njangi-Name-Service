...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld)
        payable
        ERC721("NjangiDomain Name Service", "NNS")
    {
        tld = _tld;
    ...
    function register(string calldata name) public payable {
        ...
        require(msg.value >= _price, "Not enough Matic paid bro");
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domain on the Njangi name services", "image": "data:image/svg+xml;base64,',
